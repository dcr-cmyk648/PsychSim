...
| Subjective response and wording                | Versioned runtime-excluded expression banks, explicit source bindings, action/instrument responses, and frozen contributor-preserving projections                 | Shared compiler/runtime integration and compatibility migration remain disabled                                                                      | `ticket.catalog.findings.subjective-presentation-projection-foundation` (resolved 2026-07-28)           |
...
| Medication and intervention knowledge          | Medication identities, 13 compatibility definitions, one stable file/ID per treatment or disposition, modality-only therapy selection, reaction policies          | Normalize medication regimen benefit/risk/duplication; therapy efficacy, combination, redundancy, capability, and balance remain separately reviewed | `ticket.catalog.medications.normalized-regimen-risk-benefit`; intervention identity resolved 2026-07-28 |
