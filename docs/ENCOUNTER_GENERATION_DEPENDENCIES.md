...
There is no canonical finding-definition catalog to own their identity or value semantics.
...
| Atomic findings                          | Case-local `FindingBlueprint`, typed outcomes, structured result display                                 | One canonical reusable finding definition, resolved value, contributor provenance, and projection contract                                      | `ticket.catalog.findings.canonical-definition-boundary`                                                            |
...
1. `ticket.catalog.findings.canonical-definition-boundary`
